...
const djsSet = (aTime, config) => {
  ...
  return (0, import_dayjs.default)(aTime).set("year", years).set("month", months).set("day", days).set("hour", hours).set("minute", minutes).set("second", seconds).set("millisecond", milliseconds);
};
